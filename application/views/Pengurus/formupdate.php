            ...
            <form id="form_poliklinik" class="form-horizontal">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" id="nama_pengurus" placeholder="Nama Pengurus" value="<?= $ao->nama_pengurus ?>">
                    <input type="hidden" class="form-control form-control-sm" id="id_pengurus" placeholder="Nama Pengurus" value="<?= $ao->id_pengurus ?>">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control form-control-sm" name="jabatan" id="jabatan">
                      <option value="<?= $ao->jabatan ?>"><?= $ao->jabatan ?></option>
...
<script>
  function updateSaveJO() {
    debugger
    PatchURL = _baseurl.concat('/Pengurus/updateSave');

    var vid_pengurus = $("#id_pengurus").val();
