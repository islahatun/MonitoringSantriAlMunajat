...
class PrestasiRoleSantri extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('MFunction');
        $this->load->model('MPrestasiRoleSantri');
    }
    ...
    public function index()
    {
        ...
        $data['content_overview'] = $this->load->view('PrestasiRoleSantri', $data, true);
        $this->load->view('overview', $data);
    }

    public function datalist()
    {
        $list = $this->MPrestasiRoleSantri->datalist();
